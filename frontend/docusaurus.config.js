...
const config = {
  ...
  url: 'https://nihal-hackathon-book.vercel.app',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For Vercel deployment with custom domain, use '/' for root
  baseUrl: '/',
  ...
  onBrokenLinks: 'throw',
  // onBrokenMarkdownLinks: 'warn', // This option is deprecated. Moved to markdown.hooks.onBrokenMarkdownLinks below.
  markdown: {
    format: 'mdx',
    mermaid: false,
    hooks: {
      onBrokenMarkdownLinks: 'warn', // New location for the deprecated option
    },
  },
